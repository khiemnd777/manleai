...
export const metadata: Metadata = {
  ...
  description: "ManleAI hỗ trợ cuộc gọi tiếng Anh, trả lời theo dữ liệu salon và ghi nhận yêu cầu lịch hẹn an toàn.",
  ...
  openGraph: { title: "ManleAI — AI lễ tân dành cho tiệm nail", description: "Tiếp nhận cuộc gọi tiếng Anh với scheduling workflow được chọn rõ ràng.", url: `${marketingBaseUrl}/vi`, type: "website", images: ["/brand/manle-ai-logo.png"] }
};
