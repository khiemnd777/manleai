...
- Canonical services/categories/aliases own guidance identity. Authority-
  ...
  V81: common collection versions cover service/staff catalogs, aliases,
...
- Answer-source routing and cached structured context:
  ...
  external snapshot changes retain their existing fences. V81 adds persisted
  ...
  turn. Provider connection fields are normalized out for `owner_manual` and
