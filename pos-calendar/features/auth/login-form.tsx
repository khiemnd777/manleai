  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      ...
      <label className="block">
        ...
        <div className="mt-2 flex h-11 min-h-11 items-center gap-2 rounded-md border border-line bg-white px-3 shadow-sm transition focus-within:border-brand focus-within:ring-2 focus-within:ring-brand/15">
          <Mail className="h-4 w-4 flex-none text-muted" />
          <input
      ...
      <label className="block">
        ...
        <div className="mt-2 flex h-11 min-h-11 items-center gap-2 rounded-md border border-line bg-white px-3 shadow-sm transition focus-within:border-brand focus-within:ring-2 focus-within:ring-brand/15">
          <LockKeyhole className="h-4 w-4 flex-none text-muted" />
          <input
            className="h-full min-w-0 flex-1 bg-transparent text-sm text-ink outline-none placeholder:text-slate-400"
            value={password}
      ...
      {bootstrapAvailable ? (
        <p className="text-sm leading-6 text-muted">
          First owner account setup is available in the main admin frontend.
        </p>
      ) : null}
    </form>
  );
