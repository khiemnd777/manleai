    ...
    <div className="mx-auto max-w-4xl space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm leading-6 text-muted">
          This creates the tenant record used by auth, dashboard data, and Square OAuth.
        </p>
      </div>

      <div className="grid gap-4 md:grid-cols-3">
        {["Salon Profile", "Square Connect", "AI Booking Gate"].map((step, index) => (
      ...
      {error ? <Alert title="Salon profile failed" message={error} /> : null}
      {success ? <Alert type="success" title="Salon created" message={success} /> : null}
